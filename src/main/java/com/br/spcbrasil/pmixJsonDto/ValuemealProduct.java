...
public class ValuemealProduct {
    ...
    public ValuemealProduct(){
        super();
    }

    public ValuemealProduct(String count, String product_id, String price, String amount, String third_party_id, String a_la_carte_price, String product_name, String mode) {
        this.count = count;
        this.product_id = product_id;
        this.price = price;
        this.amount = amount;
    ...
    public String toString() {
        return "ValuemealDto [count=" + count + ", product_id=" + product_id + ", price="+ price + ",amount="+ amount + ",third_party_id=" + third_party_id
